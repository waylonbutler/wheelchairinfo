...
<div class="band">
  ...
  <ol>
    ...
    <li><strong>Turn the power OFF at the joystick before moving it.</strong> Then use freewheel mode (below) to roll it. Do not force it against the motors.</li>
...
<ol>
  ...
  <li>Push the chair from the <strong>frame of the power base</strong>. Two people. Never push on the seat back, joystick, armrests, or footplate.</li>
...
<div class="band">
  ...
  <ol>
    ...
    <li><strong>Apague la silla en el joystick antes de moverla.</strong> Luego use el modo de rueda libre (abajo) para rodarla. No la empuje contra los motores.</li>
...
<ol>
  ...
  <li>Empuje la silla desde el <strong>bastidor de la base</strong>. Dos personas. Nunca empuje el respaldo, el joystick, los apoyabrazos ni el reposapiés.</li>
